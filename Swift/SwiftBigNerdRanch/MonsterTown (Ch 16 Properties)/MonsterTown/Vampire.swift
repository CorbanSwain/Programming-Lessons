...
/// `Monster` subclass that deals minimal damage to the population. Watch out for the growing Vampire Thrall
class Vampire: Monster {
    
    /// An array of `Vampire` objects that grows with each call to `Vampire.terrorizeTown()`
